...
<body class="d-flex flex-column h-100">
  ...
  <main class="flex-shrink-0">
    <div class="container">
      <h1 class="mt-5">Welcome <?php echo $user1 = end($user); ?>!!!</h1>
  ...
  <footer class="footer mt-auto py-3 bg-light">
    <div class="container">
      <span class="text-muted" style=" text-align: center; display: inline-block; width: 100%;">Made with <svg viewBox="0 0 1792 1792" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="height: 0.8rem;">
