    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="restrict_access.php">Restrict Access</a>
          </li>
          <li class="nav-item">
...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Block Access of Institute Users</h1>
  ...
  <div class="container">
    <h1 class="mt-5">Block Access of DTE Users</h1>
    <p class="lead">Pin a footer to the bottom of the viewport in desktop browsers with this custom HTML and CSS. A fixed navbar has been added with <code class="small">padding-top: 60px;</code> on the <code class="small">main &gt; .container</code>.</p>
    <p>Back to <a href="../examples/sticky-footer/">the default sticky footer</a> minus the navbar.</p>
  </div>
</main>
